path_postgres = 'C:\\"Program Files"\\"PostgreSQL 1C"\\12\\bin\\' #  Путь в формате указываем в формате
...
db = ['db1','db22'] # список баз
path_backup = 'E:\\postgres_test\\' # путь хранения бекапов
